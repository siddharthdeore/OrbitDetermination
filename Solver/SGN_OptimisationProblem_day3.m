%% solver for observation taken on 23-03-2019
clc; clear; close all;
...
jd_obs=data(26:end,1); % julian date
RA_obs=data(26:end,2);
DEC_obs=data(26:end,3);
%%
% 1:14 -21
% 14:26 -22
% 27:end -23
...
[xp,yp,dut1,lod,ddpsi,ddeps,dx,dy,dat] = fetchSpaceData('2019 03 23');
